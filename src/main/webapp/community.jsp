...
<script type="text/javascript">
  function commu(commuNum){
	  location.href="communitySeeService?commuNum="+commuNum;
  }
										...
										<tbody
											...
											<tr class="xans-record-">
												...
												<td class="subject">
													...
													<p>
														<a
															href="communityView.jsp?commuNum=<%=cdto.get(i).getCommuNum()%>" onclick="commu(<%=cdto.get(i).getCommuNum()%>)" class="sub"><%=cdto.get(i).getCommuTitle()%></a>
													</p>
													<div class="board_footer">
														<li><%=cdto.get(i).getMemberID()%></li>
														<li class=""><%=cdto.get(i).getCommuDay()%></li>
														<li class="">HIT : (댓글수) : <%=dbdao.getCommunityComment(cdto.get(i).getCommuNum()).size() %> </li>
