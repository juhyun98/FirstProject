...
<script type="text/javascript">
	function review(reviewNum) {
		location.href = "reviewLikeService?reviewNum=" + reviewNum;
	}
	function reviewsee(reviewNum) {
		location.href = "reviewSeeService?reviewNum=" + reviewNum;
	}
</script>
</head>
<body>
				...
				<div id="main" style="background-color: white;">
					...
					<div class="reviewcontainer">
						...
						for (int i = 0; i < reviewList.size(); i++) {
							...
							reviewHTML += "<a href='reviewView.jsp?reviewNum=" + reviewList.get(i).getReviewNum() + "' onclick=\"reviewsee('"
							+ reviewList.get(i).getReviewNum() + "')\">..더 보기</a>)";
							...
							reviewHTML += "<div onclick='review(" + reviewList.get(i).getReviewNum() + ")'>좋아요</div>";
							reviewHTML += "<div>";
							reviewHTML += dbdao.getReviewLike(reviewList.get(i).getReviewNum());
							reviewHTML += "</div>";
							reviewHTML += "</button>";
							...
							reviewHTML += "<div>";
							reviewHTML += "(" + dbdao.getReviewComment(reviewList.get(i).getReviewNum()).size() + ")";
							reviewHTML += "</div>";
							reviewHTML += "</button>";
							// 조회수 버튼
							...
							reviewHTML += "<div>";
							reviewHTML += dbdao.getReviewSee(reviewList.get(i).getReviewNum());
							reviewHTML += "</div>";
							reviewHTML += "</button>";
						...
						<div
							...
							<p class="prev">
								<a
									href="review.jsp?pageNum=<%=pageNum - 1%>#<%=pageNum * 5 - 1%>-review-top"><span
									style="margin-right: 100px;">PREV</span></a>
							</p>
							<p class="next">
								<a
									href="review.jsp?pageNum=<%=pageNum + 1%>#<%=pageNum * 5 + 1%>-review-top"><span
									style="margin-left: 100px;">NEXT</span></a>
							</p>
						</div>
					</div>
